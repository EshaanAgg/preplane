package com.preplane.dev.controllers.backend.Comment;
...
public class CommentController {
    ...
    @PostMapping("/")
    public ResponseEntity<Comment> createComment(@RequestBody Comment comment, @AuthenticationPrincipal User loggedInUser) {
